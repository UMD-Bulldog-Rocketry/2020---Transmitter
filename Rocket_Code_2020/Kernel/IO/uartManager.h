...
#define BAUD_RATE_9600 ((CPU_CLK-153600))/(CPU_CLK/65536)
#define BAUD_RATE_19200 ((CPU_CLK-307200))/(CPU_CLK/65536)
#define BAUD_RATE_38400 ((CPU_CLK-614400))/(CPU_CLK/65536)
#define BAUD_RATE_57600 ((CPU_CLK-921600))/(CPU_CLK/65536)
#define BAUD_RATE_115200 ((CPU_CLK-1843200))/(CPU_CLK/65536)
#define BAUD_RATE_128000 ((CPU_CLK-2048000))/(CPU_CLK/65536)
#define BAUD_RATE_256000 ((CPU_CLK-4096000))/(CPU_CLK/65536)
